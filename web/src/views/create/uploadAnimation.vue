<template>
  <div class='createPost-container'>
    <el-form ref='animForm' :model='animForm' :rules='rules' class='form-container'>
          ...
          <el-col :span='24'>
            ...
            <div class='characterInfo-container'>
              ...
              >
                ...
                <el-form-item label="动画标签" prop="TagInput">
                  ...
                  <el-form-item label="动画描述">
                    <el-input type="textarea" v-model='animation.Desc'></el-input>
                  </el-form-item>

                  <el-form-item label="动画文件" prop='File'>
                    <el-upload
                      class='upload-demo'
                  ...
                  <el-form-item label='关联角色'>
                    ...
                    >
                      ...
                      <el-table-column prop='_id' label='id' v-model='animation.ActorList' width='200'></el-table-column>
                ...
                <el-form-item label='关联音频'>
                  ...
                  >
                    ...
                    <el-table-column prop='_id' v-model='animation.AudioList' label='id' width='120'></el-table-column>
                    <el-table-column prop='Desc' label='音频描述' show-overflow-tooltip></el-table-column>
                  </el-table>
                </el-form-item>

                  <el-form-item>
                    <el-button type="primary" @click="submitForm('animation')">提交</el-button>
                    <el-button @click="resetForm('animation')">重置</el-button>
                  </el-form-item>
...
export default {
  ...
  methods: {
    submitForm(formName) {
      this.$refs[formName].validate(valid => {
        if (valid) {
          ...
          this.$set(this.animation, 'Author', author)
          ...
          this.$set(this.animation, 'ActorList', actorSelection)
          ...
          this.$set(this.animation, 'AudioList', audioSelection)

          if (this.TagInput.length === 0){
              this.$set(this.animation, 'Tag', this.TagSelect)
          } else{
          ...
          if (this.$route.params.id){
            this.$set(this.animation, 'AuditStatus', '未审核')
            this.$http.put(`Animation/${this.$route.params.id}`, this.animation).then(res => {
              console.log(res.data);
            })
          } else {
            this.$http.post('animation', this.animation).then(res => {
              console.log(res.data);
            })
          }
          alert('提交成功!');
          // this.$router.push('/Animation/index')
          this.$router.push('/AnimationManage')
        } else {
    ...
    handleSelectionChange(res) {
      ...
      // console.log(res)
      // this.$set(this.animation, 'File', res)
    },
    ...
    afterUploadFile(res){
      this.$set(this.animation, 'File', res.url)
    }
  }
}
</script>
