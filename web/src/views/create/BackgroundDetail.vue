...
<div class="item-detail-show">
  <div class="item-detail-right">
    <el-descriptions title="背景详情" direction="vertical" :column="4" border>
      <el-descriptions-item label="名称">{{background.Name}}</el-descriptions-item>
      <el-descriptions-item label="标签" :span="4">
        <el-tag size="small" v-for="tag in background.Tag" :key="tag">{{ tag }}</el-tag>
      </el-descriptions-item >
      <el-descriptions-item label="描述" :span="4">{{background.Desc}}</el-descriptions-item>
    </el-descriptions>
    <el-button type="primary" size="mini" icon="el-icon-download"
          @click="download(background.File)">下载资源</el-button>
  </div>
</div>
