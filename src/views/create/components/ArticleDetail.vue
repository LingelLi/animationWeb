            ...
            <div class="characterInfo-container">
              ...
              >
                ...
                <el-form-item label="角色标签" prop="TagInput">
                  <el-input v-model="TagInput" placeholder="请输入自定义标签  以空格分隔" />
                </el-form-item>
                ...
                <el-form-item label="角色描述">
                  <el-input v-model="actor.Desc" type="textarea" />
                </el-form-item>
                ...
                <el-form-item label="关联动画">
                  ...
                  >
                    ...
                    <el-table-column v-model="actor.Animation" prop="_id" label="id" width="120" />
                    <el-table-column prop="Desc" label="动画描述" show-overflow-tooltip />
                  </el-table>
                </el-form-item>
                ...
                <el-form-item label="关联音频">
                  ...
                  >
                    ...
                    <el-table-column v-model="actor.AudioList" prop="_id" label="id" width="120" />
                    <el-table-column prop="Desc" label="音频描述" show-overflow-tooltip />
                  </el-table>
                </el-form-item>
